...
export type GmailCommandJob = { commandId: string; commandType: ProviderCommandType; correlationId?: string };
...
export async function enqueueProviderCommand(commandId: string, commandType: ProviderCommandType, correlationId?: string) { return gmailCommandsQueue.add("execute-command", { commandId, commandType, correlationId }, { jobId: commandId }); }
